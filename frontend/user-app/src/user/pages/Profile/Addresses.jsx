    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (editingId) {
                ...
                // Sync to user doc if it's the latest/edited one
                await updateDoc(doc(db, "users", user.uid), {
                    address: {
                        street: addrData.houseStreet,
                        area: addrData.areaLandmark,
                        city: addrData.city,
                        state: addrData.state,
                        zip: addrData.pincode
                    },
                    phone: addrData.phone // Also sync phone as backup if profile phone is missing
                });
                ...
                // Sync to user doc as the new primary address
                await updateDoc(doc(db, "users", user.uid), {
                    address: {
                        street: addrData.houseStreet,
                        area: addrData.areaLandmark,
                    ...
                    phone: addrData.phone // Also sync phone as backup
                });
